...
namespace UI
{
    ...
    public class SelectBar : MonoBehaviour
    {
        ...
        void Awake()
        {
            ...
            {
                UIManager.Instance.itemShopPanel.ShowFiltered(GoodsFilter(UIManager.Instance.itemShopPanel.goods,
                    GoodsType.ALL));
            ...
            switch (goodsType)
            {
                ...
                case GoodsType.ARMOR:
                    for (int i = 0; i < goods.childCount; i++)
                    {
                        ...
                        if (itemType == ItemType.Boots || itemType == ItemType.Breast || itemType == ItemType.Helmet ||
                            itemType == ItemType.Pants || itemType == ItemType.Shield)
                            indexs.Add(i);
                    }
