...
namespace App.SO
{
    ...
    [CreateAssetMenu(fileName = "ProgressionConfig_", menuName = "Unity RPG Project/ProgressionConfig", order = 7)]
    public class ProgressionConfig : ScriptableObject
    {
        ...
        public Attribute GetProgressionByLevel(int level)
        {
            Attribute progression = new Attribute();
