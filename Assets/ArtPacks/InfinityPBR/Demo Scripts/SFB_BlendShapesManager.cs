...
public class SFB_BlendShapesManager : MonoBehaviour {
	...
	public int GetObjectIndex(string name)
	{
		...
		Debug.LogWarning("No blend shape object named \"name\" was found!");
		return 9999;
	}

	public int GetShapeIndex(string name, int objectIndex)
	{
		...
		Debug.LogWarning("No blend shape named \"name\" was found!");
		return 9999;
	}
